...
#                ├─> private/현재본-md/플랫폼-붙여넣기.md   (자기소개·프로젝트별 설명)
...
paste:				## 이력서 + 경력기술서 → 채용 플랫폼용 자기소개·프로젝트별 설명 md
	@python3 "$(TOOL)/paste.py" "$(SRC)/이력서.html" "$(SRC)/경력기술서.html" "$(MD)/플랫폼-붙여넣기.md"
	@echo "paste   → $(MD)/플랫폼-붙여넣기.md"
...
clean:				## 산출물 md·txt 삭제 (src 는 건드리지 않음)
	@rm -f $(MD)/이력서.md $(MD)/경력기술서.md $(MD)/포트폴리오.md $(MD)/사람인-붙여넣기.txt $(MD)/플랫폼-붙여넣기.md
